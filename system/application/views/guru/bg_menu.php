...
<a href="<?php echo base_url(); ?>index.php/guru/berita"><div class="bg-menu">Berita<br /><h3>Tulis Pengumuman</h3></div></a>
<a href="<?php echo base_url(); ?>index.php/guru/kreasi_cerpen"><div class="bg-menu">KREASI CERPEN<br /><h3>Tulis Pengumuman</h3></div></a>
<a href="<?php echo base_url(); ?>index.php/guru/pengumuman"><div class="bg-menu">Penguman<br /><h3>Tulis Pengumuman</h3></div></a>
...
<a href="<?php echo base_url(); ?>index.php"><div class="bg-menu">Website SMANJO<br /><h3>Kembali ke website SMANJO</h3></div></a>
