<div id="isi">
<h1>Tambah Agenda Sekolah</h1><br />
...
<tr><td>Tema</td><td width="10">:</td><td><input type="text" name="judul" class="textfield" size="80"></td></tr>
<tr><td valign="top">Isi</td><td width="10" valign="top">:</td><td><textarea name="isi" cols="60" rows="15" class="textfield"></textarea></td></tr>
<tr><td>Mulai</td><td width="10">:</td><td>
<?php
$psh=array();
$psh=explode("-",$wkt_skr);
$tgl_skr=$psh[0];
...
<tr><td>Selesai</td><td width="10">:</td><td>
<?php
$psh=array();
$psh=explode("-",$wkt_skr);
$tgl_skr=$psh[0];
...
<tr><td>Tempat</td><td width="10">:</td><td><input type="text" name="tempat" class="textfield" size="80"></td></tr>
<tr><td>Waktu Kegiatan</td><td width="10">:</td><td><input type="text" name="jam" class="textfield" size="80"></td></tr>
<tr><td valign="top">Keterangan</td><td width="10" valign="top">:</td><td><textarea name="keterangan" cols="60" rows="5" class="textfield"></textarea></td></tr>
<tr><td valign="top"></td><td width="10" valign="top"></td><td><input type="submit" value="Simpan Agenda" class="input"></td></tr>
</form></table>
        </div>
   ...
   <p>&nbsp;</p>     
	...
	<tr>
	<td>Upload file</td><td><input type="file" name="imagefile" size="50"  class="input"/><input type="hidden" name="tujuan" value="tambahagenda" /></td>	
	</tr>
	</table>
