 <div class="content-wrapper">
                ...
                <section class="content">
              	...
              	<div class="box">
               		<div class="box-header">
                		<a href="<?php echo base_url(); ?>index.php/kreasiuser/tambahkreasipantun"><button type="button" claas="btn btn-default btn-lg">
	...
	<td><a href='".base_url()."index.php/kreasiuser/editkreasipantun/".$s['id_kreasi']."'><span class='glyphicon glyphicon-ok' aria-hidden='true'></span></a></a></td>
	<td><a href='".base_url()."index.php/kreasiuser/editkreasipantun/".$s['id_kreasi']."'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a></a></td>
