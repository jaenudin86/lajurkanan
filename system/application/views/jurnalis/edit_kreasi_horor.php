 <?php echo form_open_multipart('kreasiuser/updatekreasihoror');?>
 <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="glyphicon glyphicon-list-alt"></i>Holor</a></li>
                        <li class="active">Edit Kreasi Holor</li>
                    </ol>
                </section>
     ...
     <div class="box-body">
         <div class="row">
           		<div class="col-xs-6"> 
 <?php echo form_open_multipart('kreasiuser/updatekreasicerpen');?>
 <form role="form">  
 <?php
