 <div class="content-wrapper">
                ...
                <section class="content">
              	...
              	<div class="box">
               		<div class="box-header">
                		<a href="<?php echo base_url(); ?>index.php/jurnalis/tambahberita"><button type="button" claas="btn btn-default btn-lg">
	...
	<td><a href='".base_url()."index.php/jurnalis/editberita/".$s['id_berita']."'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a></a></td>
	<td><a href='".base_url()."index.php/jurnalis/hapusberita/".$s['id_berita']."' onClick=\"return confirm('Anda yakin ingin menghapus data ini?')\" ><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a></a></td></tr>";
	$no++;
