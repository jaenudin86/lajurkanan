...
<table width="100%">
<?php
echo "<tr align='center'><td><strong>Nomor</strong></td><td><strong>NIS</strong></td><td><strong>Nama Siswa</strong></td><td><strong>Kelas</strong></td><td><strong>Tahun Ajaran</strong></td><td colspan='2' width='10'><strong>Aksi Data</strong></td></tr>";
$no=1;
foreach($kelas->result_array() as $s)
{
	echo "<tr><td>".$no."</td><td>".$s['nis']."</td><td>".$s['nama_siswa']."</td><td>".$s['nama_kelas']."</td><td>".$s['tahun_ajaran']."</td><td>
