...
<form method="post" action="<?php echo base_url(); ?>index.php/adminweb/simpaninput" name="soal">
...
<input type="submit" class="input" value="Simpan Rekap Absensi" />
<input type="reset" class="input" value="Hapus dan Ulang Pengisian" />
</form>
</div>
