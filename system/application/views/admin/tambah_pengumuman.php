...
<div class="TabView" id="TabView1">
    ...
    <div class="Pages">
        <!--Page 1-->
        <div class="Page">
<?php echo form_open_multipart('adminweb/simpanpengumuman');?>
<table height="100%">
<tr>
<td>Judul</td>
<td>:</td>
...
<tr><td></td><td></td><td><input type="submit"  value="Simpan Data" class="input"/></td>	</tr>
   ...
   <p>&nbsp;</p>     
	...
	<tr>
	<td>Upload file</td><td><input type="file" name="imagefile" size="50"  class="input"/><input type="hidden" name="tujuan" value="tambahpengumuman" /></td>	
	</tr>
	</table>
