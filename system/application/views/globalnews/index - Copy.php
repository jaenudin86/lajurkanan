                              ...
                              <div class="row">
                                <div class="col-sm-8">
                                  <div class="vid-thumb">
                                    ...
                                    <div class="vid-box"><span class="ion-ios7-film"></span><img class="img-thumbnail" src="<?php echo base_url(); ?>system/application/views/globalnews/images/lifestyle/lifestyle-slide-2.jpg" width="300" height="132" alt=""/> </div>
                                    </a> </div>
                                </div>
                                <div class="col-sm-8">
                                  <div class="sub-topic-thumb">
                                    ...
                                    <a href="#">
                                    <div class="sub-box"><img class="img-thumbnail" src="system/application/views/globalnews/images/lifestyle/lifestyle-slide-1.jpg" width="300" height="132" alt=""/> </div>
                                    </a> </div>
                                </div>
                              </div>
                            </div>
          ...
          <div class="col-sm-16 col-md-10 col-lg-8"> 
            ...
            <div id="sync1" class="owl-carousel">
              <div class="box item"> <a href="#">
                ...
                <img  src="system/application/views/globalnews/images/banner-slider/slide-img-2.jpg" width="762" height="360" alt=""/>
              ...
              <div class="box item"> <a href="#">
                <div class="carousel-caption">Republican budget leader Paul Ryan
                  faces key test in fiscal talks</div>
                <img   src="system/application/views/globalnews/images/banner-slider/slide-img-3.jpg" width="762" height="360" alt=""/>
                <div class="overlay"></div>
                <div class="overlay-info">
                  <div class="cat">
              ...
              <div class="box item"> <a href="#">
                <div class="carousel-caption">Republican budget leader Paul Ryan
                  faces key test in fiscal talks</div>
                <img src="<?php echo base_url(); ?>system/application/views/globalnews/images/banner-slider/slide-img-4.jpg" width="762" height="360" alt=""/>
                <div class="overlay"></div>
                <div class="overlay-info">
                  <div class="cat">
              ...
              <div class="box item"> <a href="#">
                <div class="carousel-caption">Republican budget leader Paul Ryan
                  faces key test in fiscal talks</div>
                <img   src="<?php echo base_url(); ?>system/application/views/globalnews/images/banner-slider/slide-img-5.jpg" width="762" height="360" alt=""/>
                <div class="overlay"></div>
                <div class="overlay-info">
                  <div class="cat">
              ...
              <div class="box item"> <a href="#">
                <div class="carousel-caption">Republican budget leader Paul Ryan
                  faces key test in fiscal talks</div>
                <img  src="<?php echo base_url(); ?>system/application/views/globalnews/images/banner-slider/slide-img-6.jpg" width="762" height="360" alt=""/>
                <div class="overlay"></div>
                <div class="overlay-info">
                  <div class="cat">
              ...
              <div class="box item"> <a href="#">
                <div class="carousel-caption">Republican budget leader Paul Ryan
                  faces key test in fiscal talks</div>
                <img  src="<?php echo base_url(); ?>system/application/views/globalnews/images/banner-slider/slide-img-7.jpg" width="762" height="360" alt=""/>
                <div class="overlay"></div>
                <div class="overlay-info">
                  <div class="cat">
                    <p class="cat-data"><span class="ion-model-s"></span>Lifestyle</p>
              ...
              <div class="box item"> <a href="#">
                <div class="carousel-caption">Republican budget leader Paul Ryan
                  faces key test in fiscal talks</div>
                <img   src="<?php echo base_url(); ?>system/application/views/globalnews/images/banner-slider/slide-img-8.jpg" width="762" height="360" alt=""/>
                <div class="overlay"></div>
                <div class="overlay-info">
                  <div class="cat">
              ...
              <div class="box item"> <a href="#">
                <div class="carousel-caption">Republican budget leader Paul Ryan
                  faces key test in fiscal talks</div>
                <img  src="<?php echo base_url(); ?>system/application/views/globalnews/images/banner-slider/slide-img-1.jpg" width="762" height="360" alt=""/>
                <div class="overlay"></div>
                <div class="overlay-info">
                  <div class="cat">
                    <p class="cat-data"><span class="ion-model-s"></span>lifestyle</p>
            ...
            <div class="row">
              <div id="sync2" class="owl-carousel">
                <div class="item"><img class="img-responsive" src="<?php echo base_url(); ?>system/application/views/globalnews/images/banner-slider/slide-img-2.jpg" width="762" height="360" alt=""/></div>
                <div class="item"><img class="img-responsive" src="<?php echo base_url(); ?>system/application/views/globalnews/images/banner-slider/slide-img-3.jpg" width="762" height="360" alt=""/></div>
                <div class="item"><img class="img-responsive " src="<?php echo base_url(); ?>system/application/views/globalnews/images/banner-slider/slide-img-4.jpg" width="762" height="360" alt=""/></div>
                <div class="item"><img class="img-responsive " src="<?php echo base_url(); ?>system/application/views/globalnews/images/banner-slider/slide-img-5.jpg" width="762" height="360" alt=""/></div>
                <div class="item"><img class="img-responsive " src="<?php echo base_url(); ?>system/application/views/globalnews/images/banner-slider/slide-img-6.jpg" width="762" height="360" alt=""/></div>
                <div class="item"><img class="img-responsive" src="<?php echo base_url(); ?>system/application/views/globalnews/images/banner-slider/slide-img-7.jpg" width="762" height="360" alt=""/></div>
                <div class="item"><img class="img-responsive " src="<?php echo base_url(); ?>system/application/views/globalnews/"images/banner-slider/slide-img-8.jpg" width="762" height="360" alt=""/></div>
                <div class="item"><img class=" img-responsive" src="<?php echo base_url(); ?>system/application/views/globalnews/"images/banner-slider/slide-img-1.jpg" width="762" height="360" alt=""/></div>
              </div>
            </div>
          </div>
              ...
              <div class="col-lg-6 hidden-md"><a href="#">
                <div class="box">
                  <div class=" carousel-caption">Extreme biking:
                    dangerous, dirty
                    and Fun</div>
                  <img class="match-height" src="<?php echo base_url(); ?>system/application/views/globalnews/"images/banner-static/bs-1.jpg" width="236" height="480"  alt="" />
                  <div class="overlay"></div>
                  <div class="overlay-info">
                    <div class="cat">
                      <p class="cat-data"><span class="ion-model-s"></span>Lifestyle</p>
                ...
                <div class="row">
                  <div class="col-sm-16 right-img-top "> <a href="#">
                    <div class="box">
                      <div class="carousel-caption">Best snack ever: mini mac and
                        cheese cupcakes</div>
                      <img class="img-responsive" src="<?php echo base_url(); ?>system/application/views/globalnews/images/banner-static/bs-2.jpg" width="440" height="292" alt=""/>
                      <div class="overlay"></div>
                      <div class="overlay-info">
                        <div class="cat">
                          <p class="cat-data"><span class="ion-model-s"></span>Lifestyle</p>
                  ...
                  <div class="col-sm-16 right-img-btm "> <a href="#">
                    <div class="box">
                      ...
                      <img class="img-responsive" src="<?php echo base_url(); ?>system/application/views/globalnews/images/banner-static/bs-3.jpg" width="440" height="292" alt=""/>
                      <div class="overlay"></div>
                      <div class="overlay-info">
                        <div class="cat">
                          <p class="cat-data"><span class="ion-model-s"></span>Lifestyle</p>
    ...
    <div class="row "> 
      ...
      <div class="col-md-11 col-sm-11">
        <div class="row"> 
              ...
              <div class="col-md-11 col-sm-16">
                <div class="row">
                  <div class="col-md-8 col-sm-9 col-xs-16">
                    <div class="topic"> <a href="#"><img class="img-thumbnail" src="<?php echo base_url(); ?>system/application/views/globalnews/images/business/business-main.jpg" width="600" height="398" alt=""/>
                  ...
                  <div class="col-md-8 col-sm-7 col-xs-16">
                    <ul class="list-unstyled">
                      <li> <a href="#">
                        <div class="row">
                          <div class="col-sm-5 hidden-sm hidden-md"><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/business/business-th-1.jpg" width="76" height="76" alt=""/> </div>
                      ...
                      <li> <a href="#">
                        <div class="row">
                          <div class="col-sm-5 hidden-sm hidden-md"><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/business/business-th-2.jpg" width="76" height="76" alt=""/> </div>
                          <div class="col-sm-16 col-md-16 col-lg-11">
                      ...
                      <li> <a href="#">
                        <div class="row">
                          <div class="col-sm-5 hidden-sm hidden-md"><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/business/business-th-3.jpg" width="76" height="76" alt=""/> </div>
                          <div class="col-sm-16 col-md-16 col-lg-11">
                            <h4>Nielsen forecasts smaller black friday </h4>
                            <div class="text-danger sub-info">
                              <div class="time"><span class="ion-android-data icon"></span>Dec 16 2014</div>
                      ...
                      <li> <a href="#">
                        <div class="row">
                          <div class="col-sm-5 hidden-sm hidden-md"><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/business/business-th-4.jpg" width="76" height="76" alt=""/> </div>
                          <div class="col-sm-16 col-md-16 col-lg-11">
                  ...
                  <div class="item">
                    <div class="vid-thumb-outer">
                      <div class="vid-thumb"><a class="popup-youtube" href="https://www.youtube.com/watch?v=TEnNaUg6Vm4">
                        <div class="vid-box"><span class="ion-ios7-film"></span><img class="img-thumbnail img-responsive" src="<?php echo base_url(); ?>system/application/views/globalnews/images/business/business-vid-1.jpg" width="250" height="143" alt=""/> </div>
                        <h4>Perspiciatis unde omnis iste natus</h4>
                        </a> </div>
                      <div class="vid-thumb"><a class="popup-youtube" href="http://vimeo.com/7396421">
                        <div class="vid-box"><span class="ion-ios7-film"></span><img class="img-thumbnail img-responsive" src="<?php echo base_url(); ?>system/application/views/globalnews/images/business/business-vid-2.jpg" width="250" height="143" alt=""/> </div>
          ...
          <div class="col-sm-16">
            <div class="row">
              <div class="col-xs-16 col-sm-8  wow fadeInLeft animated science" data-wow-delay="0.5s" data-wow-offset="130">
                ...
                <div class="row">
                  <div class="topic col-sm-16"> <a href="#"><img class=" img-thumbnail" src="<?php echo base_url(); ?>system/application/views/globalnews/images/science/sci-main.jpg" width="600" height="227" alt=""/>
                  ...
                  <div class="col-sm-16">
                    <ul class="list-unstyled  top-bordered ex-top-padding">
                      <li> <a href="#">
                        <div class="row">
                          <div class="col-lg-3 col-md-4 hidden-sm  "><img width="76" height="76" alt="" src="<?php echo base_url(); ?>system/application/views/globalnews/images/science/sci-th-1.jpg" class="img-thumbnail pull-left"> </div>
                      ...
                      <li> <a href="#">
                        <div class="row ">
                          <div class="col-lg-3 col-md-4 hidden-sm  "><img width="76" height="76" alt="" src="<?php echo base_url(); ?>system/application/views/globalnews/images/science/sci-th-2.jpg" class="img-thumbnail pull-left"> </div>
                          <div class="col-lg-13 col-md-12">
                            <h4>Irish cream and chocolate
                              cheesecake </h4>
                            <div class="text-danger sub-info">
              ...
              <div class="col-sm-8 col-xs-16 wow fadeInRight animated" data-wow-delay="0.5s" data-wow-offset="130">
                ...
                <div class="row left-bordered">
                  <div class="topic col-sm-16"> <a href="#"> <img  class="img-thumbnail" src="<?php echo base_url(); ?>system/application/views/globalnews/images/travel/travel-main.jpg" width="600" height="227" alt=""/>
                  ...
                  <div class="col-sm-16">
                    <ul class="list-unstyled top-bordered ex-top-padding">
                      <li> <a href="#">
                        <div class="row">
                          <div class="col-lg-3 col-md-4 hidden-sm  "><img width="76" height="76" alt="" src="<?php echo base_url(); ?>system/application/views/globalnews/images/travel/travel-th-1.jpg" class="img-thumbnail pull-left"> </div>
                          <div class="col-lg-13 col-md-12">
                            <h4>Irish cream and chocolate
                              cheesecake </h4>
                            <div class="text-danger sub-info">
                      ...
                      <li> <a href="#">
                        <div class="row ">
                          <div class="col-lg-3 col-md-4 hidden-sm  "><img width="76" height="76" alt="" src="<?php echo base_url(); ?>system/application/views/globalnews/images/travel/travel-th-2.jpg" class="img-thumbnail pull-left"> </div>
                          <div class="col-lg-13 col-md-12">
                            <h4>Irish cream and chocolate
                              cheesecake </h4>
                            <div class="text-danger sub-info">
          ...
          <div class="col-sm-16 wow fadeInUp animated " data-wow-delay="0.5s" data-wow-offset="100">
            ...
            <div class="row">
              <div id="owl-lifestyle" class="owl-carousel owl-theme lifestyle pull-left">
                <div class="item topic"> <a href="#"> <img class="img-thumbnail" src="<?php echo base_url(); ?>system/application/views/globalnews/images/lifestyle/lifestyle-slide-1.jpg" width="300" height="132" alt=""/>
                ...
                <div class="item topic"> <a href="#"> <img class="img-thumbnail" src="<?php echo base_url(); ?>system/application/views/globalnews/images/lifestyle/lifestyle-slide-2.jpg" width="300" height="132" alt=""/>
                  <h4>Etiam rhoncus. Maecenas tempus, tellus eget condimentum</h4>
                  <div class="text-danger sub-info-bordered remove-borders">
                    <div class="time"><span class="ion-android-data icon"></span>Dec 9 2014</div>
                    <div class="comments"><span class="ion-chatbubbles icon"></span>204</div>
                ...
                <div class="item topic"> <a href="#"> <img class="img-thumbnail" src="<?php echo base_url(); ?>system/application/views/globalnews/images/lifestyle/lifestyle-slide-3.jpg" width="300" height="132" alt=""/>
                  <h4>Etiam rhoncus. Maecenas tempus, tellus eget condimentum</h4>
                  <div class="text-danger sub-info-bordered remove-borders">
                    <div class="time"><span class="ion-android-data icon"></span>Dec 9 2014</div>
                    <div class="comments"><span class="ion-chatbubbles icon"></span>204</div>
              ...
              <div class="col-sm-5 col-xs-2"> <!-- required for floating --> 
                ...
                <ul class="nav nav-tabs tabs-right hidden-xs">
                  <li class="active"><a data-toggle="tab" href="#vid-first">
                    <div class="vid-thumb">
                      <div class="vid-box"><span class="ion-eye"></span><img class="img-thumbnail" src="<?php echo base_url(); ?>system/application/views/globalnews/images/recent-videos/re-vid-1.jpg" width="234" height="87" alt=""/> </div>
                    </div>
                    </a></li>
                  <li class=""><a data-toggle="tab" href="#vid-second">
                    <div class="vid-thumb">
                      <div class="vid-box"><span class="ion-eye"></span><img class="img-thumbnail" src="<?php echo base_url(); ?>system/application/views/globalnews/images/recent-videos/re-vid-2.jpg" width="234" height="87" alt=""/> </div>
                    </div>
                    </a></li>
                  <li class=""><a data-toggle="tab" href="#vid-third">
                    <div class="vid-thumb">
                      <div class="vid-box"><span class="ion-eye"></span><img class="img-thumbnail" src="<?php echo base_url(); ?>system/application/views/globalnews/images/recent-videos/re-vid-3.jpg" width="234" height="87" alt=""/> </div>
                    </div>
                    </a></li>
                </ul>
              </div>
          ...
          <!--Recent videos end--> 
          <!--wide ad start-->
          <div class="col-sm-16 wow fadeInDown animated " data-wow-delay="0.5s" data-wow-offset="25"><img class="img-responsive" src="<?php echo base_url(); ?>system/application/views/globalnews/images/ads/728-90-ad.gif" width="728" height="90" alt=""/></div>
          <!--wide ad end--> 
      ...
      <div class="col-sm-5 hidden-xs right-sec">
        <div class="bordered top-margin">
          <div class="row ">
            <div class="col-sm-16 bt-space wow fadeInUp animated" data-wow-delay="1s" data-wow-offset="50"> <img class="img-responsive" src="<?php echo base_url(); ?>system/application/views/globalnews/images/ads/336-280-ad.gif" width="336" height="280" alt=""/> <a href="#" class="sponsored">sponsored advert</a> </div>
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="popular">
                  <ul class="list-unstyled">
                    <li> <a href="#">
                      <div class="row">
                        <div class="col-sm-5 col-md-4"><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/popular/pop-1.jpg" width="164" height="152" alt=""/> </div>
                    ...
                    <li> <a href="#">
                      <div class="row">
                        <div class="col-sm-5  col-md-4 "><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/popular/pop-2.jpg" width="164" height="152" alt=""/> </div>
                        <div class="col-sm-11 col-md-12">
                    ...
                    <li> <a href="#">
                      <div class="row">
                        <div class="col-sm-5  col-md-4 "><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/popular/pop-3.jpg" width="164" height="152" alt=""/> </div>
                        <div class="col-sm-11 col-md-12">
                          <h4>The evolution of the apple ..</h4>
                          <div class="text-danger sub-info">
                            <div class="time"><span class="ion-android-data icon"></span>Dec 16 2014</div>
                    ...
                    <li> <a href="#">
                      <div class="row">
                        <div class="col-sm-5  col-md-4 "><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/popular/pop-4.jpg" width="164" height="152" alt=""/> </div>
                        <div class="col-sm-11 col-md-12">
                          <h4>The evolution of the apple ..</h4>
                          <div class="text-danger sub-info">
                            <div class="time"><span class="ion-android-data icon"></span>Dec 16 2014</div>
                    ...
                    <li> <a href="#">
                      <div class="row">
                        <div class="col-sm-5  col-md-4 "><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/popular/pop-5.jpg" width="164" height="152" alt=""/> </div>
                        <div class="col-sm-11 col-md-12">
                          <h4>The evolution of the apple ..</h4>
                          <div class="text-danger sub-info">
                            <div class="time"><span class="ion-android-data icon"></span>Dec 16 2014</div>
                ...
                <div class="tab-pane" id="comments">
                  <ul class="list-unstyled">
                    <li> <a href="#">
                      <div class="row">
                        <div class="col-sm-5  col-md-4 "><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/comments/com-1.jpg" width="164" height="152" alt=""/> </div>
                        <div class="col-sm-11  col-md-12 ">
                    ...
                    <li> <a href="#">
                      <div class="row">
                        <div class="col-sm-5  col-md-4 "><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/comments/com-2.jpg" width="164" height="152" alt=""/> </div>
                        <div class="col-sm-11  col-md-12 ">
                          <h4>The evolution of the apple ..</h4>
                    ...
                    <li> <a href="#">
                      <div class="row">
                        <div class="col-sm-5  col-md-4 "><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/comments/com-3.jpg" width="164" height="152" alt=""/> </div>
                        <div class="col-sm-11  col-md-12 ">
                          <h4>The evolution of the apple ..</h4>
                    ...
                    <li> <a href="#">
                      <div class="row">
                        <div class="col-sm-5  col-md-4 "><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/comments/com-4.jpg" width="164" height="152" alt=""/> </div>
                        <div class="col-sm-12">
                          <h4>The evolution of the apple ..</h4>
                    ...
                    <li> <a href="#">
                      <div class="row">
                        <div class="col-sm-5  col-md-4 "><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/comments/com-5.jpg" width="164" height="152" alt=""/> </div>
                        <div class="col-sm-11  col-md-12 ">
                          <h4>The evolution of the apple ..</h4>
        ...
        <div class="row match-height-container">
          ...
          <div class="col-sm-5 recent-posts  wow fadeInDown animated" data-wow-delay="1s" data-wow-offset="40">
            ...
            <ul class="list-unstyled">
              <li> <a href="#">
                <div class="row">
                  <div class="col-sm-4"><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/footer-recent/f-recent-1.jpg" width="70" height="70" alt=""/> </div>
                  <div class="col-sm-12">
                    <h4>The evolution of the apple ..</h4>
              ...
              <li> <a href="#">
                <div class="row">
                  <div class="col-sm-4 "><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/footer-recent/f-recent-2.jpg" width="70" height="70" alt=""/> </div>
                  <div class="col-sm-12">
                    <h4>The evolution of the apple ..</h4>
                    <div class="f-sub-info">
                      <div class="time"><span class="ion-android-data icon"></span>Dec 16 2014</div>
              ...
              <li> <a href="#">
                <div class="row">
                  <div class="col-sm-4"><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/views/globalnews/images/footer-recent/f-recent-3.jpg" width="70" height="70" alt=""/> </div>
                  <div class="col-sm-12">
                    <h4>The evolution of the apple ..</h4>
                    <div class="f-sub-info">
                      <div class="time"><span class="ion-android-data icon"></span>Dec 16 2014</div>
