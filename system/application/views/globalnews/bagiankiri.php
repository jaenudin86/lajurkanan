        ...
        <div class="row"> 
          ...
          <div class="col-sm-16 business  wow fadeInDown animated" data-wow-delay="1s" data-wow-offset="50">
            <div class="main-title-outer pull-left">
              <div class="main-title">Ekspresi</div>
            ...
            <div class="row">
              <div class="col-md-11 col-sm-16">
                <div class="row">
                  <div class="col-md-8 col-sm-9 col-xs-16">
                   <?php
  					foreach($expresi->result_array() as $s){
  					$gambar = $s['gambar_kreasi']; $isi=substr($s['isi_kreasi'],0,200); ?>
                    <div class="topic"> <a href="#"><img class="img-thumbnail" src="<?php echo base_url(); ?>system/application/views/main-web/berita/<?php echo $gambar; ?>" width="600" height="398" alt=""/>
                      <h3><?php echo$s['judul_kreasi']?></h3>
                      <div class="text-danger sub-info-bordered">
                        <div class="time"><?php echo$s['tanggal_kreasi']?></div>
                        <div class="comments"><?php echo$s['author']?></div>
                        <div class="stars"></div>
                      </div>
                      </a>
                      <p><?php echo $isi;?></p>
 			...
 			?>  
                  ...
                  <div class="col-md-8 col-sm-7 col-xs-16">
                    ...
                    <?php
  					foreach($expresifour->result_array() as $s){
  					$gambar = $s['gambar_kreasi']; $isi=substr($s['isi_kreasi'],0,60); ?>
                      <li> <a href="#">
                        <div class="row">
                          <div class="col-sm-5 hidden-sm hidden-md"><img class="img-thumbnail" src="<?php echo base_url(); ?>system/application/views/main-web/berita/<?php echo $gambar; ?>" width="76" height="76" alt=""/> </div>
                          <div class="col-sm-16 col-md-16 col-lg-11">
                            <h4><?php echo$s['judul_kreasi']?></h4>
              ...
              <div class="col-sm-11 col-xs-16"> 
                ...
                <div class="tab-content">
                  ...
                  <div id="vid-second" class="tab-pane embed-responsive embed-responsive-16by9">
                    <iframe width="514" height="289" frameborder="0" allowfullscreen="" src="http://www.youtube.com/embed/TEnNaUg6Vm4?rel=0&am p;showinfo=0"></iframe>
                  </div>
          ...
          <div class="row ">
           <!-
            ...
            <div class="col-sm-16 bt-space wow fadeInUp animated" data-wow-delay="1s" data-wow-offset="35">
              <div class="main-title-outer pull-left">
                <div class="main-title">Galeri</div>
              </div>
...
echo' <li><a href="'.base_url().'index.php/web/berita/'.$b["id_berita"].'">
<div class="row">
<div class="col-sm-5">
<img class="img-thumbnail pull-left" src='.base_url().'system/application/views/main-web/berita/'.$b['gambar'].' width="164" height="152" </div>
<div class="col-sm-11  col-md-12 ">
<h4> '.$b['judul_berita'].'
<div class="text-danger sub-info"> 
<div class="time"><span class="ion-android-data icon"></span>'. $b['tanggal'].'-'.$b['waktu'].' WIB</div></h3>
</div>
</div>
</div>
</a>
...
?>
<a href="<?php echo base_url(); ?>index.php/web/semuaberita"><div class="submitButton">Lihat Semua Berita</div></a>
                  </ul>
                </div>
                <!-- Recent -->
                <!--
                <div class="tab-pane" id="recent">
                  <ul class="list-unstyled">
                    <li> <a href="#">
                      <div class="row">
                        < class="col-sm-5  col-md-4 "><img class="img-thumbnail pull-left" src="<?php echo base_url(); ?>system/application/viewsdiv/globalnews/images/popular/pop-5.jpg" width="164" height="152" alt=""/> </div>
                        <div class="col-sm-11  col-md-12 ">
