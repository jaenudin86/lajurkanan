        ...
        <div class="col-md-11 col-sm-11">
          <div class="row">
            ...
            <?php
  			...
  			$gambar = $s['photo']; $isi=substr($s['kegiatan'],0,230);	?>
              <div class="row">
                ...
                <div class="col-sm-9"> <a href="<?php base_url()?>/lajurkanan/web/komunitasdetail/<?php echo$s["id_komunitas"]?>">
                  <div class="sec-info">
                    <h3><?php echo $s['nama']  ?></h3>
                    <div class="text-danger sub-info-bordered">
                      <div class="time"></span><?php echo $s['wilayah']  ?></div>
