          ...
          <div class="row"> 
            ...
            <div class="col-sm-16">
             ...
             <?php
  			...
  			$gambar = $s['gambar'];	?>	
                    <div class="col-sm-16">
                     <img width="700" height="606" alt="" src="<?php echo base_url(); ?>system/application/views/main-web/berita/<?php echo $gambar; ?>"</div>
 
                    <div class="col-sm-16 sec-info">
                      <h3><?php echo $s['judul_berita']; ?></h3>
                      <div class="text-danger sub-info-bordered">
                        <div class="author"><span class="ion-person icon"></span>By: <?php echo $s['author']; ?></div>
                        <div class="time"><span class="ion-android-data icon"></span><?php echo $s['tanggal']; ?></div>
