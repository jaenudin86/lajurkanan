  ...
  <div class="container"> 
    ...
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Kreasi Pantun</li>
      </ol>
    </div>
      ...
      <div class="row "> 
        ...
        <div class="col-md-11 col-sm-11">
          <div class="row">
            ...
            <?php
  			foreach($pantun->result_array() as $s){
              ...
              <div class="row">
                ...
                <div class="col-sm-9"> <a href="<?php base_url()?>/lajurkanan/web/pantundetail/<?php echo$s["id_kreasi"]?>">
                  <div class="sec-info">
