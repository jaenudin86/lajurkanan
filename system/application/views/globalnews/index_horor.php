  ...
  <div class="container"> 
    ...
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Kreasi Cerita Horor</li>
      </ol>
    </div>
      ...
      <div class="row "> 
        ...
        <div class="col-md-11 col-sm-11">
          <div class="row">
            ...
            <?php
  			foreach($horor->result_array() as $s){
  			$gambar = $s['gambar_kreasi']; $isi=substr($s['isi_kreasi'],0,230);	?>
              <div class="row">
                <div class="col-sm-7"><img width="1000" height="300" alt="" src="<?php echo base_url(); ?>system/application/views/main-web/berita/<?php echo $gambar; ?>" class="img-thumbnail"></div>
                <div class="col-sm-9"> <a href="<?php base_url()?>/lajurkanan/web/horordetail/<?php echo$s["id_kreasi"]?>">
                  <div class="sec-info">
                    <h3><?php echo $s['judul_kreasi']  ?></h3>
                    <div class="text-danger sub-info-bordered">
                      <div class="time"></span><?php echo $s['tanggal_kreasi']  ?></div>
                      <div class="comments"></span><?php echo $s['author']  ?></div>
                      <div class="stars"><span class="ion-ios7-star"></span></span></span><span class="ion-ios7-star"></span><span class="ion-ios7-star-half"></span></div>
                    </div>
                  </div>
                  </a>
                  <p><?php echo $isi  ?> </p>
