        ...
        <div class="col-md-11 col-sm-11">
          <div class="row">
            ...
            <?php
  			...
  			$gambar = $s['gambar']; $isi=substr($s['isi'],0,230);	?>
              <div class="row">
                ...
                <div class="col-sm-9"> <a href="<?php base_url()?>/lajurkanan/web/beritadetail/<?php echo$s["id_berita"]?>">
                  <div class="sec-info">
                    <h3><?php echo $s['judul_berita']  ?></h3>
                    <div class="text-danger sub-info-bordered">
                      <div class="time"></span><?php echo $s['tanggal']  ?></div>
