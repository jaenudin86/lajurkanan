  ...
  <div class="container">
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Cerita Horor Detail</li>
      </ol>
    </div>
  </div>
  <!-- bage header End --> 
        ...
        <div class="col-md-11 col-sm-11">
          <div class="row"> 
            ...
            <div class="col-sm-16">
             ...
             <?php
  			foreach($detail_berita->result_array() as $s){
  			$gambars = $s['gambar_kreasi'];	?>	
                    <div class="col-sm-16">
                     <img width="700" height="606" alt="" src="<?php echo base_url(); ?>system/application/views/main-web/berita/<?php echo $gambars; ?>"</div>
 
                    <div class="col-sm-16 sec-info">
                      <h3><?php echo $s['judul_kreasi']; ?></h3>
                      <div class="text-danger sub-info-bordered">
                        <div class="author"><span class="ion-person icon"></span>By: <?php echo $s['author']; ?></div>
                        <div class="time"><span class="ion-android-data icon"></span><?php echo $s['tanggal_kreasi']; ?></div>
                        <div class="comments"><span class="ion-chatbubbles icon"></span><?php echo $s['counter']; ?></div>
                        <div class="stars"><span class="ion-ios7-star"></span><span class="ion-ios7-star"></span><span class="ion-ios7-star"></span><span class="ion-ios7-star"></span><span class="ion-ios7-star-half"></span></div>
                      </div>
                      <p>
                      <?php echo $s['isi_kreasi']; ?>
                      </p>
                      <hr>
                    </div>
 <?php } ?>
