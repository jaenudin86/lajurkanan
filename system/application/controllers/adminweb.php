...
class Adminweb extends Controller {
	...
	function editberita()
	{
		...
		$data['scriptmce'] = $this->scripttiny_mce();
			...
			$data["statis"] = $this->Admin_model->Menu_Statis();
			$data["imglist"]=$this->Admin_model->getDataGambar();
			$data["wilayah"]=$this->Admin_model->Tampil_Data_Wilayah();
	...
	function app_statusberita()
	{
		...
		if($session!=""){
			...
			if($data["status"]=="admin"){
				$data["status_app"] = "02";
				$this->Admin_model->Update_Status_app("tbl_berita",$data,"id_berita");
	...
	function wilayah()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$data["wilayah"] = $this->Admin_model->wilayah($offset,$limit);
			$tot_hal = $this->Admin_model->Total_Artikel("tbl_pengumuman");
			$config['base_url'] = base_url() . '/index.php/adminweb/wilayah/';
			$config['total_rows'] = $tot_hal->num_rows();
			$config['per_page'] = $limit;
			$config['uri_segment'] = 3;
			$config['first_link'] = 'Awal';
	...
	function tambahwilayah()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$data["imglist"]=$this->Admin_model->getDataGambar();
			$this->load->view('admin/bg_atas',$data);
			$this->load->view('admin/tambah_wilayah',$data);
			//$this->load->view('admin/bg_bawah');
			}
			else{
			?>
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$data2["wilayah"]=$this->input->post('wilayah');
				...
				{
					$this->Admin_model->Simpan_Artikel("tbl_wilayah",$data2);
					echo "<meta http-equiv='refresh' content='0; url=".base_url()."index.php/adminweb/wilayah'>";
				}
			}
			else{
			?>
	...
	function editwilayah()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$data["statis"] = $this->Admin_model->Menu_Statis();
			$data["imglist"]=$this->Admin_model->getDataGambar();
			$data["detail"]=$this->Admin_model->Edit_Content("tbl_wilayah","id_wialayah=".$id."");
			$this->load->view('admin/bg_atas',$data);
	...
	function updatewilayah()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			if($data["status"]=="admin"){
				$data2["wilayah"]=$this->input->post('wilayah');
				$this->Admin_model->Update_Content("tbl_wilayah",$data2,"id_wilayah");
	   			echo "<meta http-equiv='refresh' content='0; url=".base_url()."index.php/adminweb/wilayah'>";
			}
			else{
			?>
	...
	function hapuswilayah()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			if($data["status"]=="admin"){
			$this->Admin_model->Delete_Content($id,"id_wilayah","tbl_wilayah");
	   		echo "<meta http-equiv='refresh' content='0; url=".base_url()."index.php/adminweb/wilayah'>";
			}
			else{
			?>
	...
	function komunitas()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$data["berita"] = $this->Admin_model->Komunitas($offset,$limit);
			$tot_hal = $this->Admin_model->Total_Artikel("tbl_komunitas");
			//$status_app['status'] = $this->Admin_model->Status_App("tbl_berita");
			$config['base_url'] = base_url() . '/index.php/adminweb/komunitas/';
			$config['total_rows'] = $tot_hal->num_rows();
			$config['per_page'] = $limit;
			$config['uri_segment'] = 3;
			$config['first_link'] = 'Awal';
			...
			$data["page"] = $page;
			$this->load->view('admin/bg_atas',$data);
			$this->load->view('admin/komunitas',$data);
			//$this->load->view('admin/bg_bawah');
			}
			else{
			?>
	...
	function editkomunitas()
	{
		...
		$data['scriptmce'] = $this->scripttiny_mce();
			...
			$data["detail"]=$this->Admin_model->Edit_Content("tbl_komunitas","id_komunitas=".$id."");
			$data["wilayah"]=$this->Admin_model->Tampil_Data_Wilayah();
			$this->load->view('admin/bg_atas',$data);
			$this->load->view('admin/edit_komunitas',$data);
			//$this->load->view('admin/bg_bawah');
			}
			else{
			?>
	...
	function tambahkomunitas()
	{
	    ...
	    $data['scriptmce'] = $this->scripttiny_mce();
			...
			$data["wilayah"]=$this->Admin_model->Tampil_Data_Wilayah();
			$this->load->view('admin/bg_atas',$data);
			$this->load->view('admin/tambah_komunitas',$data);
			}
			else{
			?>
			<script type="text/javascript" language="javascript">
	...
	function simpankomunitas() 
	{
	  ...
	  $data['scriptmce'] = $this->scripttiny_mce();
			...
			$data2["wilayah"] = $this->input->post('kawasan');
				...
				{	
					...
					$config['max_size'] = '10000';
					$config['max_width'] = '4000';
					$config['max_height'] = '4000s';						
					$this->load->library('upload', $config);
				
					if(empty($_FILES['userfile']['name'])){
					$data2["photo"]= "welcome.jpg";
					$this->Admin_model->Simpan_Artikel("tbl_komunitas",$data2);
					echo "<meta http-equiv='refresh' content='0; url=".base_url()."index.php/adminweb/komunitas'>";
					}
					else{
						if(!$this->upload->do_upload())
						{
	...
	function hapuskomunitas()
	{
	  ...
	  $data['scriptmce'] = $this->scripttiny_mce();
			if($data["status"]=="admin"){
			$this->Admin_model->Delete_Content($id,"id_komunitas","tbl_komunitas");
	   		echo "<meta http-equiv='refresh' content='0; url=".base_url()."index.php/adminweb/komunitas'>";
			}
			else{
			?>
