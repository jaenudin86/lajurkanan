<?php
class Kreasiuser extends Controller {
	...
	function Kreasiuser()
	{
		...
		$this->load->plugin();
		$this->load->model(array('Web_model', 'Kreasi_model', 'Jurnalis_model'));
		session_start();
	}
	...
	function Kreasipuisi()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$user = $data["username"];
				//$data["kreasi"] = $this->jurnalis_model->Berita($offset,$limit,$user);
			$data["kreasi"] = $this->Jurnalis_model->Kreasipuisi($offset,$limit, $user);
			$tot_hal = $this->Jurnalis_model->Total_Kreasipuisi("tbl_kreasi", $user);
			...
			$data["page"] = $page;
			$this->load->view('jurnalis/bg_atas',$data);
			$this->load->view('jurnalis/kreasi_puisi',$data,$status_app);
			//$this->load->view('jurnalis/bg_bawah');
			}
			else{
			?>
	...
	function Kreasicerpen()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$user = $data["username"];
			$data["kreasi"] = $this->Jurnalis_model->Kreasicerpen($offset,$limit, $user);
			$tot_hal = $this->Jurnalis_model->Total_Kreasicerpen("tbl_kreasi", $user);
			$status_app['status'] = $this->Kreasi_model->Status_App("tbl_kreasi");
			$config['base_url'] = base_url() . '/index.php/kreasi/Kreasipuisi/';
			$config['total_rows'] = $tot_hal->num_rows();
			$config['per_page'] = $limit;
			...
			$data["page"] = $page;
			$this->load->view('jurnalis/bg_atas',$data);
			$this->load->view('jurnalis/kreasi_cerpen',$data,$status_app);
			//$this->load->view('jurnalis/bg_bawah');
			}
			else{
			?>
	...
	function tambahkreasicerpen()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$this->load->view('jurnalis/bg_atas',$data);
			$this->load->view('jurnalis/tambah_kreasi_cerpen',$data);
			//$this->load->view('jurnalis/bg_bawah');
			}
			else{
			?>
	   	...
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$data2["category_kreasi"] = "2"; // puisi
				if(empty($content) && empty($data2["judul_kreasi"]) && empty($data2["isi_kreasi"]))
				{
					...
					echo "<meta http-equiv='refresh' content='0; url=".base_url()."index.php/Kreasiuser/Kreasicerpen'>";
					}
					else{
	...
	function editkreasicerpen()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$this->load->view('jurnalis/bg_atas',$data);
			$this->load->view('jurnalis/edit_kreasi_cerpen',$data);
			//$this->load->view('jurnalis/bg_bawah');
			}
			else{
			?>
	...
	function editkreasipuisi()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$data["detail"]=$this->Kreasi_model->Edit_Content("tbl_kreasi","id_kreasi=".$id."");
			$this->load->view('jurnalis/bg_atas',$data);
			$this->load->view('jurnalis/edit_kreasi_puisi',$data);
			//$this->load->view('jurnalis/bg_bawah');
			}
			else{
			?>
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			if(empty($_FILES['userfile']['name'])){
				...
				$data2["tanggal_kreasi"]=$this->input->post('tanggal_kreasi');
				$data2["status_app"]=$this->input->post('status_app');
				$this->jurnalis_model->Update_Content("tbl_kreasi",$data2,"id_kreasi");
	   			echo "<meta http-equiv='refresh' content='0; url=".base_url()."index.php/kreasiuser/Kreasicerpen'>";
				}
			}
			}
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			if(empty($_FILES['userfile']['name'])){
				...
				$data2["status_app"]=$this->input->post('status_app');
				$this->Kreasi_model->Update_Content("tbl_kreasi",$data2,"id_kreasi");
				echo "<meta http-equiv='refresh' content='0; url=".base_url()."index.php/kreasiuser/Kreasipuisi'>";
			}
			else{
				if(!$this->upload->do_upload())
				{
	...
	function tambahkreasipuisi()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			//$data["imglist"]=$this->Kreasi_model()->getDataGambar();
			$this->load->view('jurnalis/bg_atas',$data);
			$this->load->view('jurnalis/tambah_kreasi_puisi',$data);
			//$this->load->view('jurnalis/bg_bawah');
			}
			else{
			?>
...
function Kreasihoror()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$user = $data["username"];
			$data["kreasi"] = $this->Jurnalis_model->Kreasihoror($offset,$limit, $user);
			$tot_hal = $this->Jurnalis_model->Total_Kreasihoror("tbl_kreasi", $user);
			$status_app['status'] = $this->Kreasi_model->Status_App("tbl_kreasi");
			$config['base_url'] = base_url() . '/index.php/kreasi/Kreasipuisi/';
			$config['total_rows'] = $tot_hal->num_rows();
			$config['per_page'] = $limit;
			...
			$data["page"] = $page;
			$this->load->view('jurnalis/bg_atas',$data);
			$this->load->view('jurnalis/kreasi_horor',$data,$status_app);
			//$this->load->view('jurnalis/bg_bawah');
			}
			else{
			?>
	...
	function tambahkreasihoror()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			//$data["imglist"]=$this->Kreasi_model()->getDataGambar();
			$this->load->view('jurnalis/bg_atas',$data);
			$this->load->view('jurnalis/tambah_kreasi_horor',$data);
			//$this->load->view('jurnalis/bg_bawah');
			}
			else{
			?>
	   	...
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$data2["category_kreasi"] = "3"; // puisi
				if(empty($content) && empty($data2["judul_kreasi"]) && empty($data2["isi_kreasi"]))
				{
					...
					$data2["gambar_kreasi"]= "welcome.jpg";
					$this->Kreasi_model->Simpan_Artikel("tbl_kreasi",$data2);
					echo "<meta http-equiv='refresh' content='0; url=".base_url()."index.php/Kreasiuser/Kreasihoror'>";
					}
					else{
						if(!$this->upload->do_upload())
						{
	...
	function editkreasihoror()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$data["detail"]=$this->Kreasi_model->Edit_Content("tbl_kreasi","id_kreasi=".$id."");
			$this->load->view('jurnalis/bg_atas',$data);
			$this->load->view('jurnalis/edit_kreasi_horor',$data);
			//$this->load->view('jurnalis/bg_bawah');
			}
			else{
			?>
	...
	function Kreasipantun()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$user = $data["username"];
			$data["kreasi"] = $this->Jurnalis_model->Kreasipantun($offset,$limit, $user);
			$tot_hal = $this->Jurnalis_model->Total_Kreasipantun("tbl_kreasi", $user);
			$status_app['status'] = $this->Kreasi_model->Status_App("tbl_kreasi");
			...
			$data["page"] = $page;
			$this->load->view('jurnalis/bg_atas',$data);
			$this->load->view('jurnalis/kreasi_pantun',$data,$status_app);
			//$this->load->view('jurnalis/bg_bawah');
			}
			else{
			?>
	...
	function tambahkreasipantun()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			//$data["imglist"]=$this->Kreasi_model()->getDataGambar();
			$this->load->view('jurnalis/bg_atas',$data);
			$this->load->view('jurnalis/tambah_kreasi_pantun',$data);
			//$this->load->view('jurnalis/bg_bawah');
			}
			else{
			?>
	...
	function editkreasipantun()
	{
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			$data["detail"]=$this->Kreasi_model->Edit_Content("tbl_kreasi","id_kreasi=".$id."");
			$this->load->view('jurnalis/bg_atas',$data);
			$this->load->view('jurnalis/edit_kreasi_pantun',$data);
			//$this->load->view('jurnalis/bg_bawah');
			}
			else{
			?>
		...
		$data["status"]=$pecah[2];
	   	$data['scriptmce'] = $this->scripttiny_mce();
			...
			if(empty($_FILES['userfile']['name'])){
				...
				$data2["status_app"]=$this->input->post('status_app');
				$this->Kreasi_model->Update_Content("tbl_kreasi",$data2,"id_kreasi");
				echo "<meta http-equiv='refresh' content='0; url=".base_url()."index.php/kreasiuser/Kreasipantun'>";
			}
			else{
				if(!$this->upload->do_upload())
				{
