...
class Admin_model extends Model
	{
		...
		{
			$q=$this->db->query("select id_berita, judul_berita, isi, gambar, tanggal, waktu, author, counter, status_app,wilayah as kawasan  from tbl_berita inner  join tbl_wilayah on tbl_berita.kawasan   = tbl_wilayah.id_wialayah order by id_berita DESC LIMIT $offset,$limit");
			return $q;
		}
